 ...
 *
 * A source link can optionally sit to the right of the viewport, sharing
 * the same hover trigger so it appears/disappears in sync with the bar.
 */
            ...
            >
              ...
              {isActive && (
                <div className="pb-pips">
                  {Array.from({ length: c.steps.length }, (_, s) => (
                    <span
                      key={s}
                      className={`pb-pip ${
